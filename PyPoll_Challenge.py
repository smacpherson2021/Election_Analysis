...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes2 > winning_count2) and (vote_percentage2 > winning_county_percentage):
            winning_count2 = votes2
            winning_county_name = county_name
            winning_county_percentage = vote_percentage2
    ...
    for candidate_name in candidate_votes:
        ...
        if (votes > winning_count1) and (vote_percentage > winning_percentage):
